...
<%@page import="com.VeryFAST.web.model.TypeDetails"%>
<%@page import="com.VeryFAST.web.dao.TypeDetailsDao"%>
...
<body class="bg-dark">
	...
	<div class="container">
		...
		<br>
		<br>
		<p class="h1 font-monospace text-white text-center">New Schedule</p>
	</div>
	<div class="container">
		<form class="form-vertical" name="newSchedule"
			...
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Schedule ID:</label>
				<div class="col-sm-2">
					<input class="form-control" type="number" placeholder="Schedule ID"
						name="ScheduleID" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Select Cinema ID:</label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Select Movie:</label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Select Time:</label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Select Date:</label>
				<div class="col-sm-2">
