...
<div class="text-center">
	...
	<div class="container">
		<br> <br> <br>
		<p class="h1 font-monospace text-white text-center">New Type</p>
	</div>
	<div class="container">
		<form class="form-horizontal" name="newType"
			...
			<div class="form-group">
				<label class="control-label col-sm-2 text-white">Type ID:</label>
				<div class="col-sm-2">
					<input class="form-control" type="number" name="TypeID"
						placeholder="Enter Type ID" required min="0">
				</div>
			</div>
